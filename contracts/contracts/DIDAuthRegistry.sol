...
contract DIDAuthRegistry is Ownable, ReentrancyGuard {
    ...
    function verifyAuthentication(
        ...
        // Verify signature against challenge hash (OpenZeppelin v5)
        bytes32 messageHash = MessageHashUtils.toEthSignedMessageHash(session.challengeHash);
        address recoveredSigner = ECDSA.recover(messageHash, _signature);
        
        // SECURITY: Ensure signature recovery returned a valid address
