...
describe('VC-JWT Service', () => {
    ...
    test('should issue a valid VC-JWT', () => {
        const result = (0, vcJwt_service_1.issueEmploymentVcJwt)(validInput);
    ...
    test('should produce a decodable JWT with correct claims', () => {
        const result = (0, vcJwt_service_1.issueEmploymentVcJwt)(validInput);
        const decoded = jsonwebtoken_1.default.decode(result.jwt);
    ...
    test('should generate unique credential IDs', () => {
        const r1 = (0, vcJwt_service_1.issueEmploymentVcJwt)(validInput);
        const r2 = (0, vcJwt_service_1.issueEmploymentVcJwt)(validInput);
    ...
    test('JWT should be verifiable with the correct secret', () => {
        ...
        const verified = jsonwebtoken_1.default.verify(result.jwt, secret);
        expect(verified.iss).toBe(validInput.issuerDid);
        expect(verified.vc).toBeDefined();
    });
});
//# sourceMappingURL=vcJwt.service.test.js.map