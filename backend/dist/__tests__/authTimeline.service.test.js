...
describe('AuthTimeline Service', () => {
    test('should add an event and return it with generated fields', () => {
        const event = (0, authTimeline_service_1.addAuthTimelineEvent)({
    ...
    test('should list events with default pagination', () => {
        ...
        const result = (0, authTimeline_service_1.listAuthTimelineEvents)({});
    ...
    test('should respect limit parameter', () => {
        const result = (0, authTimeline_service_1.listAuthTimelineEvents)({ limit: 2 });
    ...
    test('should support cursor-based pagination', () => {
        ...
        const page1 = (0, authTimeline_service_1.listAuthTimelineEvents)({ limit: 3, cursor: 0 });
        expect(page1.returned).toBeLessThanOrEqual(3);
        if (page1.hasMore && page1.nextCursor !== null) {
            const page2 = (0, authTimeline_service_1.listAuthTimelineEvents)({ limit: 3, cursor: page1.nextCursor });
    ...
    test('summarizeAuthTimeline should return correct counts', () => {
        (0, authTimeline_service_1.addAuthTimelineEvent)({ eventType: 'verification_succeeded', status: 'success' });
        (0, authTimeline_service_1.addAuthTimelineEvent)({ eventType: 'verification_failed', status: 'failure' });
        (0, authTimeline_service_1.addAuthTimelineEvent)({ eventType: 'challenge_created', status: 'info' });
        const summary = (0, authTimeline_service_1.summarizeAuthTimeline)();
...
//# sourceMappingURL=authTimeline.service.test.js.map